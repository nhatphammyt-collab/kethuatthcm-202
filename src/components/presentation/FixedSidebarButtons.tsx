  ...
  return (
    <div className="fixed bottom-8 right-6 z-50 flex flex-col gap-3">
      ...
      <button 
        ...
        className="group flex items-center gap-3 px-5 py-4 bg-gradient-to-r from-[#FFD700] to-[#e6c200] text-[#b30000] font-bold rounded-xl hover:scale-105 transition-all shadow-lg hover:shadow-xl border-2 border-[#b8960a] animate-pulse hover:animate-none"
      >
